...
config.default_prog = { os.getenv 'HOME' .. '/.local/scripts/tmux-attach.sh' }
config.automatically_reload_config = true

local fontSettings = G.font.family and { { family = G.font.family, weight = G.font.weight, italic = false } } or {}
...
config.line_height = G.font.lineHeight
